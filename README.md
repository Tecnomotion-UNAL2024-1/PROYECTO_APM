...
Daniel Delgado (Chief Executive Officer): Cumplió con el rol de líder planeando y dirigiendo reuniones, fomentó el trabajo colaborativo, la discusión de ideas para llegar a consensos y de proyectar una visión inicial de lo que podía ser el proyecto. Se encargó del diseño de la planta en Tecnomatix y del diseño de procesos de la Digital Factory en NX.
Danilo Insuasty (Chief Operating Officer): Cumplió un rol de facilitador haciendo que las reuniones fueran más dinámicas y productivas, siempre estuvo al tanto de las necesidades del grupo y de tener claro los objetivos a los que apuntaba. Se encargó de apoyar el diseño de la planta en Tecnomatix, diseñó modelos 3D y sensores y señales en la Digital Factory.
Wilfer Fiquitiva (Chief Product Officer): Sus aportes desde su experiencia en el campo clarificó muchos aspectos de la producción, y contribuyó a tomar decisiones acertadas frente al desarrollo del proyecto. Fue el principal encargado del diseño de la celda robótica y la rutina del robot de paletizado en Robotstudio. Apoyó en el análisis económico.
Theylor Amaya (Chief Automation Officer): Su iniciativa por el uso de nuevas tecnologías le dió un toque distintivo al proyecto. Se encargó principalmente de la obtención y análisis de los KPIs. Además de ser el principal diseñador de la página web.
Juan Cardenas (Chief Financial Officer): Su compromiso a pesar de las dificultades fue fundamental para el desarrollo del proyecto y su constante ánimo colaborativo impulsó aspectos fundamentales al integrar partes. Fue el principal ejecutor de la evaluación económica, apoyó en el diseño de la página web y aportó en el diseño de la celda robótica, especialmente en los aspectos de seguridad.
Johan Castellanos (Chief Technology Officer): Su atención al detalle hizo que sus aportes y su retroalimentación siempre fueran útiles, su proactividad en el desarrollo de las actividades agilizaron el desarrollo de las actividades. Fue el principal diseñador de la programación de los PLC mediante GRAFCET y Ladder en Studio 5000, apoyó en el análisis económico.

La colaboración con los docentes fue esencial para aclarar dudas y adquirir una comprensión más detallada del proyecto, las interacciones con el profesor Cardenas y el profesor Ubaldo fueron muy relevantes en la posterior toma de decisiones, además las reuniones con todo el equipo de profesores fueron enriquecedoras, el detalle que se logró fue principalmente por el sentido de importancia que transmitieron los profesores a eso que en un principio se obvió pero que más adelante demostró tener implicaciones fundamentales en el avance exitoso del proyecto.
...
Crear secciones con los nombres de cada integrante
Johan Castellanos: Para el proceso de aprendizaje, y en especial el aprendizaje enfocado en problemas, fue complicado. Este tipo de aprendizaje depende mucho de que las condiciones se den y que el problema esté definido desde un principio. Enfocar el trabajo en problemas es un método interesante y bastante nutritivo para la ingeniería en general. Fue enriquecedor tener un problema y buscar cómo desarrollarlo. Si bien era lo que esperaba, también fue innecesariamente difícil. No fue difícil por el hecho de tener que afrontar la problemática del trabajo, sino por las situaciones y coyonturas que afectaron al curso.
Creo que se pudo llegar a un trabajo aceptable dadas las circunstancias y las limitaciones, pero teniendo en cuenta las dificultades, creo que incluso con la coyuntura se podría haber logrado algo más completo con una mejor organización general. Me siento conforme con lo que aprendí en los procesos y líneas de producción y la aplicación de varios elementos vistos a lo largo de la carrera. Considero que los logros mínimos de aprendizaje se alcanzaron de una u otra forma.

Daniel Delgado: El proceso de aprendizaje con las actividades planteadas fue una experiencia enriquecedora ya que se tocaron muchos temas interesantes con un énfasis en la aplicación de esos conocimientos a problemas concretos, además que se tenía una visión más allá de lo académico enfrentado problemas que pueden presentarse en la industria, que no necesariamente son problemas técnicos sino en gran medida problemas de planeación, comunicación y demás.
Me costó en el inicio porque nunca me había enfrentado a un proyecto que implicase tanto detalle e investigación, siendo que se tuvo que diseñar una planta desde cero, considerar horarios de trabajadores, layout de la planta, consideraciones económicas, nuevos conceptos desde un punto de vista gerencial con indicadores y análisis de datos para la toma de decisiones.
Pienso que todo el esfuerzo que implicó el proyecto dió sus frutos, a pesar de todas las complicaciones que surgieron y las circunstancias en las que se dió el curso, se logró hacer un trabajo que considero de calidad y que me alegra mucho. 

Danilo Insuasty: El proceso de aprendizaje en este curso ha sido satisfactorio, a pesar de las dificultades inherentes a la situación actual de la universidad. Si bien es cierto que se adquirieron nuevos conocimientos técnicos y se aplicaron conceptos prácticos, considero que uno de los mayores logros fue el desarrollo de habilidades para trabajar efectivamente en equipo. 
Este tipo de trabajos colaborativos nos brindan la oportunidad de experimentar dinámicas únicas, propias de cada grupo. Aprendimos a afrontar y resolver los retos que se presentaron de manera conjunta, poniendo a prueba nuestra capacidad para coordinar esfuerzos, establecer roles, comunicarnos asertivamente y tomar decisiones colectivas. Aunque existieron obstáculos, el proceso de aprendizaje resultó efectivo gracias a la disposición de todos los miembros del equipo por adaptarse y encontrar soluciones.
...
Theylor Amaya:  El proceso de aprendizaje en este proyecto ha sido un desafío gratificante, especialmente en lo referente a la modelación de KPI en Tecnomotion y el diseño de la página web. A pesar de las complicaciones surgidas durante el curso, fue posible aplicar conocimientos técnicos y habilidades adquiridas a lo largo de la carrera.

Trabajé en el modelado de indicadores clave de rendimiento (KPI) en la plataforma Tecnomotion, lo cual implicó un análisis profundo de datos y la creación de modelos que ayudaran a medir la eficiencia y efectividad del proyecto. Este enfoque permitió identificar áreas de mejora y optimizar procesos, lo que fue esencial para el éxito del proyecto.

Además, me encargué del diseño de la página web, uniendo aspectos técnicos y creativos para desarrollar una interfaz funcional y atractiva que facilitara la presentación del proyecto. Esta tarea requirió un equilibrio entre la usabilidad y la estética, asegurando que la información fuera accesible y clara para todos los usuarios.

A pesar de las dificultades, considero que el esfuerzo valió la pena. Los conocimientos aplicados y las habilidades desarrolladas durante este proceso no solo contribuyeron al proyecto actual, sino que también me prepararon para enfrentar desafíos futuros en el ámbito profesional. Estoy satisfecho con los resultados obtenidos y con la calidad del trabajo realizado en equipo.



Juan Pablo Cardenas:  A pesar de las dificultades relacionadas a la situación de la universidad, el equipo logró realizar un trabajo conjunto donde se destacaron conocimientos individuales para construir así el proyecto. Destaco el compromiso de mis compañeros por buscar avanzar y ensamblar los distintos resultados en pro de dar rigurosidad al proyecto. También es importante observar que se realizó un trabajo arduo en determinar soluciones a las incógnitas que surgían a lo largo del proyecto, de manera proactiva y recursiva. 

Desde mi perspectiva como encargado en análisis financiero, puse en práctica conocimientos respecto a la contabilidad que se puede llevar en una empresa, utilizando las herramientas y su disponibilidad para llegar a un mejor rendimiento en la producción de mercancías
...
Crear secciones con los nombres de cada integrante
Johan Castellanos: Para futuros trabajos en el curso, y siendo extremadamente sincero, creo que no solo hubo errores de parte de nosotros los alumnos (varios errores), sino que también hubo errores por parte de los docentes. Estos errores, para mí, fueron:
Entrega tardía del documento que implica la problemática: Esto es muy claro. Desde el principio del semestre, se solicitó el documento de trabajo para poder enfocar desde el inicio el proyecto y las clases vistas. Lamentablemente, esta problemática fue enviada una o dos semanas antes de la primera entrega. El problema fue que los cambios realizados a lo que se mencionó verbalmente por cada docente no fueron consistentes. En específico, al principio (para ser precisos, en la primera y tercera semana) se mencionó que se buscaba una línea de producción para un producto, pero al final fueron tres productos con diferencias importantes entre sí. Además, en un punto se mencionó que el proyecto podría ser la automatización de una planta o la automatización de una parte de una planta, la cual compartiríamos entre los tres grupos del curso, y no estaba claro. Como grupo, por falta de este documento, decidimos empezar a desarrollar la problemática con un enfoque de una línea para toda la planta, pero esto tuvo cambios importantes solo dos semanas antes de la primera entrega, lo que resultó en un retraso innecesario. En un punto, un docente mencionó que la idea de esto era para que aplicáramos el modelo de "fast tracking"; sin embargo, y según lo explicado por el docente Luis Miguel, este modelo de trabajo solo funciona si todo lo demás funciona, es decir, si no hay contratiempos, porque un retraso implica retrasos en cada aspecto siguiente y claramente las coyunturas causaron esos contratiempos.
Organización y comunicación en el grupo docente: Esto se evidenció en aspectos clave y palpables. Primero, en un punto, uno de los docentes envió un mensaje cancelando la clase y que nos encontraríamos en la próxima sesión. Sin embargo, ese mensaje llegó mientras teníamos clase con otro de los docentes, lo que da a entender que no estaban coordinados. Otro caso específico fue que otro docente no llegó a la clase a tiempo porque no sabía si le tocaba a él o cuál era el salón. Esto, aunque le puede suceder a cualquier persona, también deja ver que los docentes no estaban coordinados y tenían poca comunicación entre sí. Otro aspecto, relacionado con el punto anterior, es que uno de los docentes dijo: "Yo no tengo claro cuál es el proyecto. Este proyecto fue coordinado por los otros docentes, pero yo no lo tengo claro. Este proyecto se propuso por la experiencia de uno de los docentes en el área, pero yo no sé nada del proyecto". Esto simplemente deja ver que los docentes no tenían claro al principio qué era lo que se suponía que haríamos los alumnos. Esto se sintió como si el enfoque fuese "yo dicto mi tema y los otros docentes sus temas, y si les sirve o no, es problema de los alumnos".
Finalmente, estamos en este punto en donde toca correr y cada grupo avanzó a su ritmo. Esto, aunque es problema de cada grupo, se vio afectado por la organización del curso, el proyecto y los docentes. Mi opinión es simple: tener claro el proyecto desde la semana 1 y que cada docente sepa para qué se usa cada módulo que enseña. Por lo tanto, requieren comunicación.

Mis Errores y Futuros trabajos personales: En cuanto a mis errores y los de futuros proyectos personales (o los que logro evidenciar, seguro tengo más):
Organización: No supe cómo organizar mi horario desde el principio y esto, tanto al inicio como a la mitad del desarrollo del proyecto, causó que no pudiera tener las tareas en el momento requerido. Esto, sin lugar a dudas, dañó el enfoque de "fast tracking" y llegó a causar inconvenientes con compañeros en el grupo. Sin embargo, gracias a la comunicación, organización y compromiso que se logró retomar, pudimos avanzar, especialmente con la dependencia de mi trabajo particular.
Comunicación: En algunos puntos, creo que no fui lo suficientemente proactivo en mi comunicación y esto causó inconvenientes que considero que pudimos haber solucionado.
Trabajo en equipo: Se llegó a desarrollar un buen trabajo en equipo en la última etapa, pero pudo ser mejor desde el principio. Aunque esto no es meramente mi culpa directa, sí fue mi culpa debido a mis condiciones personales, mis responsabilidades personales y mi organización entre el trabajo y mi vida personal.
Preparación: Los errores anteriores solo causaron que en el momento en que hubo problemas personales, estos afectaron rotundamente el trabajo en equipo. Un ejemplo claro fue cuando necesité ir al hospital. Si bien nadie está exento de enfermarse, mi enfermedad causó problemas en aspectos del trabajo en equipo que, por desgracia, no se pudieron solucionar. Por lo tanto, con mayor preparación se pudo haber solventado este trabajo.
Los proyectos son algo más complejo que va más allá de los conocimientos personales (habilidades duras). También implican aspectos de la persona en general. El crecimiento personal - profesional (habilidades blandas) es necesario, más de lo que se puede imaginar. Es necesario mejorar personalmente a través de la experiencia como persona. Este proyecto me permitió entender esto y me facilitará enfocarme en este aspecto personal.

Daniel Delgado: 
El Aprendizaje Basado en Problemas orientado a Proyecto es un proceso muy enriquecedor en el que se enfrentan problemas variados y difíciles de los cuales se puede aprender mucho, pero también puede tener un efecto desmotivador si no se tiene el acompañamiento adecuado ni las dinámicas correctas. Este proyecto presentó una diversidad de visiones desde la perspectivas de los profesores, al no haber un documento que planteara de manera clara los objetivos del proyecto y esto  implicó un desarrollo caótico. Se sintió desde el profesorado una exigencia desproporcionada al acompañamiento que se daba.
Desde el estudiantado también se cometieron errores respecto a la disciplina necesaria para la asignatura, dadas las problemáticas actuales de la universidad se pudo haber sido más propositivo de lado y lado.
Las guías e información compartida mediante el classroom fue de gran ayuda y se debe buscar ampliar y detallar lo que se tiene.

Danilo Insuasty:
Si bien la dinámica del Aprendizaje Basado en Problemas orientado a Proyecto representa un enfoque retador que nos impulsa a abordar problemas complejos y buscar soluciones integrales, se identifica una área de mejora clave: el acompañamiento y retroalimentación docente durante el proceso.
En un inicio, los profesores propusieron brindar un seguimiento cercano y una guía constante para orientarnos y corregir oportunamente cualquier error o desviación. Sin embargo, al acercarse los plazos de entrega final del proyecto, la premura del tiempo no permitió concretar esta dinámica de acompañamiento como fue planteada inicialmente.
En algunos casos, nos vimos enfrentados a situaciones en las que requeríamos una orientación más cercana por parte de los docentes, pero dada la particular situación que atraviesa actualmente la universidad, esta comunicación fluida entre profesores y alumnos no se logró de manera óptima, lo cual podría haber impactado en el cumplimiento de los objetivos de aprendizaje planteados para el curso.
Por lo tanto, se recomienda fortalecer los canales y estrategias de comunicación que permitan un seguimiento más cercano y personalizado por parte de los profesores desde el inicio del proyecto y durante todo su desarrollo, brindando retroalimentación constante y oportuna a los estudiantes. Esto contribuiría significativamente a maximizar el aprendizaje y a alcanzar los resultados esperados.
En el plano personal, esta experiencia ha reforzado la importancia del compromiso y la comunicación efectiva dentro de los equipos de trabajo. Si bien nuestro grupo logró sortear los desafíos gracias a estos factores, siempre existen oportunidades de mejora que nos permiten potenciar aún más nuestras habilidades y obtener resultados superiores en futuros proyectos.
...
Wilfer Fiquitiva:
Como recomendación general de la materia siento que esta materia se podría organizar en un ambiente real, en Colombia y especialmente en Bogotá existe un gran número de empresas pequeñas y medianas que pueden estar interesados en mejorar sus procesos de producción mediante la automatización de los mismos. Propongo que con anterioridad se busque una empresa a la cual se le pueda ofrecer una propuesta de mejora en sus procesos y con base a esto los estudiantes del grupo de APM trabajan entorno a cumplir este objetivo.  De tal manera que se pueda tener un contacto real con el sector industrial que permita abordar y solucionar problemas reales sin tener que imaginar o asumir información extraída de la teoría o el contenido visual que en ocasiones no brinda la información específica que se requiere y es de importancia para la simulación de los procesos y fiabilidad de los resultados.



Theylor Amaya:

Errores y Futuros Trabajos Personales:
Organización: La falta de una planificación inicial clara afectó la ejecución del proyecto. La asignación de tareas y la gestión del tiempo no fueron óptimas, lo que causó retrasos en las entregas y una carga de trabajo desbalanceada entre los miembros del equipo.
Comunicación: La comunicación ineficiente entre los miembros del equipo y con los docentes dificultó la resolución rápida de problemas. La falta de reuniones regulares y la dependencia excesiva en mensajes escritos contribuyeron a malentendidos y retrasos.
Trabajo en Equipo: La colaboración efectiva se desarrolló tardíamente. Desde el principio, hubo dificultades en la asignación de roles y responsabilidades, lo que llevó a duplicaciones de esfuerzo y falta de claridad en las tareas.
Integración de PBI y Tecnomatix: La combinación de estas herramientas presentó desafíos técnicos significativos. La falta de experiencia previa y la escasa documentación disponible complicaron la integración de los datos y la correcta utilización de ambas plataformas.
Recomendaciones:
Mejorar la Planificación: Establecer un cronograma detallado desde el inicio del proyecto, asignando tareas y responsabilidades claras a cada miembro del equipo. Realizar un seguimiento regular para asegurar el cumplimiento de los plazos.
Fortalecer la Comunicación: Implementar reuniones semanales obligatorias y utilizar herramientas de comunicación en tiempo real para resolver dudas y problemas rápidamente. Fomentar una comunicación abierta y proactiva entre todos los miembros del equipo.
Capacitación en Herramientas: Proporcionar formación específica en el uso de herramientas técnicas como PBI y Tecnomatix antes del inicio del proyecto. Asegurarse de que todos los miembros del equipo tengan un nivel básico de competencia en estas herramientas.
Documentación y Recursos: Crear y mantener una base de datos de documentación y recursos útiles para la utilización de las herramientas técnicas. Esto puede incluir tutoriales, guías de usuario y ejemplos prácticos.
Retroalimentación Continua: Establecer un sistema de retroalimentación continua con los docentes para resolver dudas y recibir orientación a lo largo del proyecto. Esto ayudará a corregir errores rápidamente y a mantener el proyecto en la dirección correcta.
...
Juan Pablo Cardenas:
Para este trabajo, recomiendo proporcionar información más detallada sobre el proyecto, específicamente en la producción de baldosas cerámicas. Hubiera sido útil contar con valores específicos de producción para obtener resultados más precisos y realistas, evitando así la necesidad de inventar o asumir datos. También quiero reconocer mis fallas, ya que por causas personales no pude dedicarme al proyecto de manera más comprometida, especialmente al final del período académico. Sin embargo, traté de cumplir con mis tareas y, aunque las entregué tarde, completé todas las que me propuse. Además, quisiera señalar las fallas de coordinación con los docentes, cuyas opiniones eran a menudo contradictorias respecto a las expectativas del proyecto, lo que dificultaba comprender lo que se requería. Sumado a esto, los profesores estuvieron ausentes en parte del semestre debido a la situación de la universidad.
